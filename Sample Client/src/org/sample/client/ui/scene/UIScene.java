...
import org.sample.client.ui.FullScreenComponentSupport;
import org.sample.client.ui.HasMenu;
...
public class UIScene extends Scene implements FullScreenComponentSupport {
    ...
    public static final int PROP_ANIMATION_DURATION = 400;

    protected static final SampleGame GAME = SampleGame.getInstance();
    ...
    private void hideLoadingImpl() {
        ...
        synchronized (reference) {
            ...
            FXUtils.removeToPane(indicator, loadingLayer);
