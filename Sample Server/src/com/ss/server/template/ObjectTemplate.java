...
public abstract class ObjectTemplate {
     ...
     */
    @NotNull
    protected <T extends GameObject> T takeInstance(@NotNull final Class<T> type, final int objectId) {
     ...
     */
    @NotNull
    public <T extends GameObject> T takeInstance(final int objectId) {
